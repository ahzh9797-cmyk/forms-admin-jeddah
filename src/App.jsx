...
const FORMS = [
  ...
  { id: 'supervisor-faris', number: null, title: 'تصحيح مشرف في فارس', description: 'طلب تصحيح بيانات موظف في نظام فارس (مشرف)', color: 'teal', component: FormSupervisorFaris },
  { id: 'manager-faris', number: null, title: 'تصحيح مدير في فارس', description: 'طلب تصحيح بيانات موظف في نظام فارس (مدير)', color: 'indigo', component: FormManagerFaris },
  { id: 'electronic-statements', number: null, title: 'إدارة الإفادات الإلكترونية', description: 'إنشاء روابط الإفادات ومتابعة الردود والتوقيع الحي', color: 'green', component: ElectronicStatements },
]
...
const COLOR_MAP = {
  ...
  green: { bg: 'bg-green-100', text: 'text-green-700', badge: 'bg-green-700', border: 'border-green-300', hover: 'hover:border-green-500' },
}
